...
public class BuildingFlatAPIService {
    private static final String TAG = "BuildingFlatAPIService";
    private BuildingFlatIServiceListener buildingFlatIServiceListener;
    private Context context;
    private AppConfigRemote appConfigRemote;

    public BuildingFlatAPIService(Context context, BuildingFlatIServiceListener buildingFlatIServiceListener) {
        this.context = context;
        //buildingFlatIServiceListener = (BuildingFlatIServiceListener) context;
        this.buildingFlatIServiceListener = buildingFlatIServiceListener;
    ...
    public void get_building_flat(int buildingId, int currentPage) {
        ...
        okHttpClient.newCall(httpRequest).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                buildingFlatIServiceListener.onBuildingFlatFailed(failResponse);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (response.code() == 200) {
                        ...
                        buildingFlatIServiceListener.onBuildingFlatSuccess(responseObject);
