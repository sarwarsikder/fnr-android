...
public class NotificationApiService {
    ...
    private NotificationIService notificationIService;
    private Context context;
    private AppConfigRemote appConfigRemote;

    public NotificationApiService(Context context) {
        this.context = context;
        notificationIService = (NotificationIService) context;
    ...
    public void get_notification(int pageId) {
        ...
        okHttpClient.newCall(httpRequest).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                notificationIService.onNotificationFailed(failResponse);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (response.code() == 200) {
                        ...
                        notificationIService.onNotificationSuccess(responseObject);

                    } else {
                        notificationIService.onNotificationFailed(responseObject);
                    }
