...
public class FlatPlanApiService {
    ...
    public FlatPlanApiService(Context context, BuildingPlansIService buildingPlansIService) {
    ...
    public void get_flat_plan(int flatId, int currentPage) {
        String requestUrl = appConfigRemote.getBASE_URL() + "/api/flat/" + flatId + "/plans/?page=" + currentPage;
